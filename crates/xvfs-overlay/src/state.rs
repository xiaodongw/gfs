...
use xvfs_types::{BytePath, EntryKind, ObjectId, Timestamp};
...
impl OverlayKind {
  ...
  pub fn git_mode(self) -> u32 {
    match self {
      OverlayKind::Regular => xvfs_types::mode::REGULAR,
      OverlayKind::Executable => xvfs_types::mode::EXECUTABLE,
      OverlayKind::Symlink => xvfs_types::mode::SYMLINK,
      OverlayKind::Directory => xvfs_types::mode::DIRECTORY,
    }
  }
