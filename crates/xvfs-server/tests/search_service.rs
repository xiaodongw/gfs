...
impl Backend {
  async fn start(fixture: &str) -> Backend {
    ...
    tokio::spawn(async move {
      tonic::transport::Server::builder()
        .add_service(xvfs_proto::SnapshotServiceServer::new(snapshot_api))
  ...
  async fn client(&self) -> xvfs_proto::SearchServiceClient<tonic::transport::Channel> {
    xvfs_proto::SearchServiceClient::connect(self.grpc.clone())
      .await
      .unwrap()
  }
}
